...
<section id="cursor-1" class="container container-cursor-1">
    <div class="wrapper">
        ...
        <div class="main-container">
            <div class="header">
                <div class="logo">--- <span class=logo-det>Cr</span></div>
            ...
            <div class="user-box first-box">
                <div class="activity card" style="--delay: .2s">
                    ...
                    <div class="activity-links">
                        <div class="activity-link active">...</div>
                        <div class="activity-link notify">...</div>
                    </div>
                ...
                <div class="discount card" style="--delay: .4s">
                    ...
                    <div class="button offer-button">---</div>
                </div>
                <%-- start calender --%>
                ...
                <div class="account-wrapper" style="--delay: .8s">
                    ...
                    <div class="account card">
                        <div class="account-cash">$ 00.0</div>
...
<script src="http://localhost:3000/Script/component/ProfessorScheduleHandler.js" type="module" ;></script>
